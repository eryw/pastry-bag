<?php
/**
 * Modified version of original CakePHP ControllerFactoryTest
 */
namespace PastryBag\Test\TestCase\Http;
...
class ControllerFactoryTest extends TestCase
{
    ...
    /**
     * Test building PastryBag\Controller\Controller derivatives
     *
     * @return void
     */
    public function testInstantiateControllerExtendPastryBagController()
    {
        $request = new Request([
            'url' => 'pastry-bag/index',
            'params' => [
        ...
        $result = $this->factory->create($request, $this->response);
        $this->assertInstanceOf('TestApp\Controller\PastryBagChildController', $result);
        $this->assertSame($request, $result->request);
        $this->assertSame($this->response, $result->response);
    }
}
